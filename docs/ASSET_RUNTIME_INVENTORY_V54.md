# Alien Tantalus Frontier — inventaire assets/runtime v54
...
| Ennemis | 52 archétypes / 11 modificateurs / 568 profils | 110 exacts; 216 réemplois famille; 242 sans art dédié |
...
| player.echo9-marine.combat | right | true | loaded-exact |
...
| Runner | 11 | enemy.xenomorph-runner.action | exact | — |
...
| Ripper Queen | 11 | enemy.ripper-queen.action | exact | — |
...
| Pale Crucible Hunter | 11 | enemy.pale-crucible-hunter.action | exact | — |
| Dust Runner | 11 | enemy.xenomorph-runner.action | authored-family | La planche Runner couvre la famille de Dust Runner, sans identité animée dédiée à cette variante. |
...
| Pathogen Mimic | 11 | enemy.pathogen-mimic.action | exact | — |
...
Les prochains lots artistiques prioritaires restent : 35 châssis véhicules, 242 profils ennemis sans art dédié, sets mission des 16 PNJ, hazards non-acide et couches indépendantes par zone.
