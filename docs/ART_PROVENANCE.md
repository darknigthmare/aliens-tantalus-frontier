...
ImageGen a livré les atlas PNG en 24 bits avec un damier de présentation opaque malgré la demande de transparence. Une tentative d’édition ImageGen en alpha a été bloquée par l’ACL locale Windows. Les masters restent utilisables comme références et planches; un détourage alpha et une découpe par cellules sont un gate obligatoire avant une utilisation sprite frame-par-frame.
