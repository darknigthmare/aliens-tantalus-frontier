...
test('le cache hors-ligne v74 précache seulement le shell et garde les atlases lourds à la demande', async () => {
  ...
  assert.match(worker, /const CACHE = ['"]atf-v74-enemy-combat-shell-1['"]/);
