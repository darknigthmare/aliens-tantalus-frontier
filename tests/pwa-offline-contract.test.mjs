...
test('le cache hors-ligne v73 précache seulement le shell et garde les atlases lourds à la demande', async () => {
  ...
  assert.match(worker, /const CACHE = ['"]atf-v73-enemy-055-shell-1['"]/);
