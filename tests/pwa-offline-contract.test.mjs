...
test('le cache hors-ligne v76 précache seulement le shell et garde les atlases lourds à la demande', async () => {
  ...
  assert.match(worker, /const CACHE = ['"]atf-v76-hub-enemy-shell-1['"]/);
