...
test('le cache hors-ligne v67 précache seulement le shell et garde les atlases ennemis à la demande', async () => {
  ...
  assert.match(worker, /const CACHE = ['"]atf-v67-shell-2['"]/);
