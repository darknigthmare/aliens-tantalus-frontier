...
test('OpenAI production masters are physically integrated', async () => {
  for (const file of ['tantalus-base-environment.png', 'echo9-sprite-sheet.png', 'xenomorph-sprite-sheet.png', 'arsenal-props-atlas.png', 'tantalus-hub-command-deck.png', 'tantalus-hub-habitat-deck.png', 'tantalus-hub-industrial-deck.png', 'tantalus-hub-engineering-deck.png', 'tantalus-hub-crew-animation-sheet.png']) await access(`assets/openai/${file}`);
});
