...
export const CONTENT_TARGETS = Object.freeze({ ...CORE_CONTENT_TARGETS, campaigns: 437 });
...
export const RELEASE = Object.freeze({
  ...PREVIOUS_RELEASE,
  version: '67.0.0',
  subtitle: 'Opérations spéciales — Cargo Brutal jouable et audit des 19 conversations',
