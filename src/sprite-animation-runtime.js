...
export const SPRITE_SHEETS = Object.freeze({
  ...
  'enemy.xenomorph-queen.action.v56': sheet('enemy.xenomorph-queen.action.v56', 'xenoQueenV56', '/assets/openai/sprites/normalized/enemies/xenomorph-queen-action-sheet-v56.png', 'enemy-action-v56', 'creature-ground', 'queen-standing', 448, 340, 'enemy'),
  ...
  'enemy.xenomorph-queen.combat': sheet('enemy.xenomorph-queen.combat', 'xenoQueen', '/assets/openai/sprites/normalized/enemies/xenomorph-queen-combat-sheet.png', 'queen-combat', 'creature-ground', 'queen-standing', 448, 340, 'enemy'),
  'enemy.ripper-queen.action': sheet('enemy.ripper-queen.action', 'ripperQueen', '/assets/openai/sprites/normalized/enemies/ripper-queen-action-sheet.png', 'ripper-queen-action', 'creature-ground', 'queen-standing', 448, 340, 'enemy'),
