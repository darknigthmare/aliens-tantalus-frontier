"""Normalize one OpenAI 4x4 sprite master and refresh the v55 QA report.

The generated master is kept as the raw project asset. This wrapper reuses
the established v50 neutral/chroma extraction and repack pipeline, writes only
the requested runtime derivative, and updates the matching report entry.
"""
...
def load_pipeline():
    spec = importlib.util.spec_from_file_location("v55_sprite_pipeline", PIPELINE_PATH)
