"""Normalize the OpenAI Alien survival systems atlas for the V70 runtime.

The RGB ImageGen master is preserved verbatim. This deterministic pass removes
only neutral checker pixels, scales the authored 4x2 board to a 1024x512 RGBA
atlas, clears cell guards and records reproducible QA/provenance metadata.
"""
...
SOURCE = ROOT / "assets/openai/sprites/frames/v70/alien-survival-systems-atlas-openai-v70.png"
OUTPUT = ROOT / "assets/openai/sprites/normalized/props/alien-survival-systems-atlas-v70.png"
REPORT = ROOT / "assets/openai/sprites/metadata/v70/alien-survival-systems-v70.json"
WIDTH = 1024
HEIGHT = 512
COLUMNS = 4
ROWS = 2
...
def main() -> None:
    ...
    for index, cell_id in enumerate(CELL_IDS):
        ...
        cells.append({
            ...
            "bounds": list(cell.getbbox() or ()),
        })
        if occupied < 500 or not cell.getbbox():
            raise SystemExit(f"Empty V70 prop cell {cell_id} at {column},{row}")
